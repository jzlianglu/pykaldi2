...
The zip files contains the raw waveforms, and *trans-ids* and *pdf-ids* are Kaldi labels in the form of transition ids and tied HMM pdf ids, which look like
  ...
  ``` 
The *pdf-ids* are used for CE training, and *trans-ids* are used for SE training. In fact, given the Kaldi transition model, we can convert *trans-ids* to *pdf-ids*, however this is slow in Python. Currently we use two versions of the labels. The labels are in plain text at the moment. We are working on supporting data and labels in the form of HDF5.
...
| model  | size |  loss | dev-clean |  dev-other | test-clean | test-other |
|--------|------|-------|-----------|------------|------------|------------|
|        |      | CE    | 4.6       | 13.4       | 5.1        | 13.5       |
|  BLSTM |  21M | MMI   | 4.3       | 12.1       | 4.8        | 12.5       |
|        |      | sMBR  | 4.3       | 12.3       | 4.9        | 12.5       |
|        |      | MPE   | 4.4       | 12.3       | 4.8        | 12.5       |
|--------|------|-------|-----------|------------|------------|------------|
|xformer | 26.6M| CE    | 4.5       | 11.5       | 4.9        | 11.8       |
|        |      | MMI   | 4.3       | 10.7       | 4.6        | 11.1       |     
|        | 40.8M| CE    | 4.1       | 11.2       | 4.7        | 11.7       |
| +Simu  | 40.8M|CE     | 3.8       | 9.5        | 4.4        | 9.8        |
